    ...
    extraOffset: function() {
      ...
      jQuery('#header').each(function() {
        ...
        if (stickyInstance) {
          stickyInstance.stickyFlag = false;
          stickyInstance.stickyOn();
          totalHeight += $box.outerHeight() + 32;
          stickyInstance.onResize();
        } else {
          totalHeight += $box.css('position') === 'fixed' ? $box.outerHeight() : 0;
        }
...
//image zooom functionality
function initImageZoom() {
  jQuery('.zoom-box').each(function() {
    var zoomBlock = jQuery(this);
    var imgUrl = zoomBlock.data('zoom-src');
    zoomBlock.zoom({
      url: imgUrl
    });
  });
...
function initCustomForms() {
  jQuery('.custom-form select option:first-child').addClass('hideme');
  ...
  jQuery('.new-placeholder input')
  // .on( 'focus', function () { jQuery(this).closest('label').hide(); } )
  .on( 'focus', function () { jQuery(this).parents().addClass('hidelabel'); } )
  .on( 'blur',  function () { if ( !jQuery(this).val() ) jQuery(this).parents().removeClass('hidelabel'); } );
}
...
function initRangeSlider() {
  jQuery("#priceRange").each( function() {
    ...
    var sliderTooltip = function(event, ui) {
      ...
      // var inputValue = maxValue - minValue;
      //console.log(minValue, maxValue);
      jQuery( "#minPrice" ).val(minValue);
      jQuery( "#maxPrice" ).val(maxValue);
      jQuery( "#minPriceText" ).text(minValue);
      jQuery( "#maxPriceText" ).text(maxValue);
...
function initCustomScript() {
  ...
  if (jQuery(window).width() < 1200) {
   ...
   jQuery("#nav").css("height", parseFloat(jQuery(window).height() - headerheight) + "px");
 }

  jQuery('.video-frame').each(function(index, el) {
    var self= jQuery(this);
    var iframe = self.find('iframe');
    var player = new Vimeo.Player(iframe);
    var btnPlay = self.find('.btn-play');
  ...
  // jQuery('.chs-plan-single-wrap .chs-btn-wrap').on('click', function (e) {
    // e.preventDefault();
    // jQuery(this).parent().addClass('plansopen');
  //   jQuery(this).next('.chs-dtl-plan').slideDown();
  // });
  ...
  jQuery('body').on("click", function () {
    if (hide) jQuery('.chs-plan-single-wrap').removeClass('plansopen').children('.chs-dtl-plan').hide();
    hide = true;

  });
  // add and remove .active
  jQuery('body').on('click', '.chs-btn-wrap', function (e) {
    e.preventDefault();
    var self = jQuery(this).parent();
    self.children('.chs-dtl-plan').show();
    self.addClass('plansopen');
    hide = false;
  });

  // Multilevel Select
  jQuery('.multilevel-select select').dropdown({
    nested: true
  });

  var selectdownHeight = jQuery(".dropdown .dropdown-menu-open").outerHeight();
  jQuery(".dropdown .dropdown-menu-open").css("min-height", parseFloat(selectdownHeight) + "px");


  jQuery('.home-features-main-wrap2 .home-feat-single:gt(3)').hide();
  var lngthft = jQuery('.home-features-main-wrap2 .home-feat-single').length;
  if (lngthft > 4) {
    jQuery('.home-feat-main-btn-wrap').show();
  } else {
    jQuery('.home-feat-main-btn-wrap').hide();
    jQuery('.home-feature-wrap').addClass('less-space-btm');
  }
  jQuery('.home-feat-main-btn-wrap a.btn').click(function (e) {
    event.preventDefault();
    jQuery('.home-features-main-wrap2 .home-feat-single:gt(3)').toggle('slideDown');
  });


  // var maxSliderHeight = -1;
  // jQuery('.events-slider-main .slick-slide').each(function() {
  //   if (jQuery(this).height() > maxSliderHeight) {
  //     maxSliderHeight = jQuery(this).height();
  //   }
  // });
  // jQuery('.events-slider-main .slick-slide').each(function() {
  //   if (jQuery(this).height() < maxSliderHeight) {
  //     jQuery(this).css('margin', Math.ceil((maxSliderHeight-jQuery(this).height())/2) + 'px 0');
  //   }
  // });

  jQuery('body').on('DOMSubtreeModified', '.grp-service .dropdown-text, .grp-state .dropdown-text, .grp-location .dropdown-text', function(){
    console.log('changed');
    jQuery(this).addClass('changedtxt');
  });
...
function initSlickCarousel() {
  ...
  jQuery('.offer-slider').slick({
    ...
    autoplaySpeed: 3000,
    rows: 0,
    prevArrow: '<button class="matat-btn matat-btn-normal slick-prev"></button>',
    nextArrow: '<button class="matat-btn matat-btn-normal slick-next"></button>',
    arrows: false,
    dots: false,
    fade: true,
    speed: 500,
  ...
  jQuery('.slider-professional').slick({
    rtl: rtlDir(),
    // slidesToScroll: 1,
    // slidesToShow: 1,
    draggable: true,
  ...
  jQuery('.sal-std-feat-slide').slick({
    rtl: rtlDir(),
    slidesToScroll: 1,
    slidesToShow: 6,
    mobileFirst: true,
    rows: 0,
    variableWidth: true,
    prevArrow: '<button class="btn slick-prev"><i class="icon-left-half-arrow"></i></button>',
    nextArrow: '<button class="btn slick-next"><i class="icon-right-half-arrow"></i></button>',
    arrows: false,
    dots: false,
    speed: 600,
    autoplay: true,
  ...
  jQuery('.testi-slider-main2').slick({
    rtl: rtlDir(),
    slidesToScroll: 1,
    // slidesToShow: 6,
    rows: 0,
    dots: false,
    arrows: true,
    prevArrow: '<button class="btn slick-prev"><span class="icon-left-half-arrow"></span></button>',
    nextArrow: '<button class="btn slick-next"><span class="icon-right-half-arrow"></span></button>',
    speed: 600,
    centerMode: true,
  ...
  jQuery('.events-slider-main').slick({
    rtl: rtlDir(),
    rows: 0,
    slidesToShow: 2,
    slidesToScroll: 1,
  ...
  // jQuery('.more-articles-wrap').slick({
  //   rtl: rtlDir(),
  //   rows: 0,
  //   slidesToShow: 1,
  //   slidesToScroll: 1,
  ...
  jQuery('.instagram-slider').slick({
    ...
    arrows: false,
    mobileFirst: true,
    prevArrow: '<button class="slick-prev"><span class="icon-left-arrow"></span></button>',
    nextArrow: '<button class="slick-next"><span class="icon-right-arrow"></span></button>',
    // centerPadding: '40rem',
    variableWidth: true,
    responsive: [{
      breakpoint: 200,
  ...
  jQuery('.abt-loc-gallery-inner').slick({
    rtl: rtlDir(),
    slidesToScroll: 1,
    // slidesToShow: 6,
    rows: 0,
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".home-features-main-wrap");
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".wp-block-gallery .gallery");
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".chs-plan-inner-wrap");
...
(function ($) {
  ...
  const init = {
    ...
    infinite: true,
    centerMode: false,
    prevArrow: '<button class="btn slick-prev"><i class="icon-plus"></i></button>',
    nextArrow: '<button class="btn slick-next"><i class="icon-minus"></i></button>',
    // centerPadding: '40rem',
  };

  $(() => {
    const win = $(window);
    const slider = $(".variation-list-inner");
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".more-articles-wrap");
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".contact-main-inner");
...
function initMobileNav() {
  ...
  jQuery('html').on('click', '.filter-close', function(event) {
      event.preventDefault();
      jQuery('body').removeClass('product_filter_active');
  });
      ...
      on: function() {
        ...
        jQuery('.sticky-faq-nav').stickyScrollBlock({
          ...
          extraTop: function() {
            var totalHeight = 0;
            jQuery('#header').each(function() {
              totalHeight += jQuery(this).outerHeight() + 32;
            });
            return totalHeight;
          }
        });
...
function initFancybox() {
  jQuery('.single-product-slider').slickLightbox({
    ...
    layouts: {
      closeButton: '<button class="slick-lightbox-close" type="button"><i class="icon-cross"></i></button>'
    },
    // itemSelector: '.img-wrap img.zoomImg',
    itemSelector: '.slide .button-zoom',
    slick: {
      rtl: true,
      prevArrow: '<button class="slick-prev"><i class="icon-right-arrow-small"></i></button>',
      nextArrow: '<button class="slick-next"><i class="icon-left-arrow-small"></i></button>',
    }
  });
}
