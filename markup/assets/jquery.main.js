...
function initCustomScript() {
  ...
  // jQuery('.chs-plan-single .chs-btn-wrap').on('click', function (e) {
  //   e.preventDefault();
  ...
  if (jQuery(window).width() > 768) {
    ...
    jQuery('body').on("click", function () {
      if (hide) jQuery('.chs-plan-single-wrap').children('.chs-dtl-plan').slideUp();
      hide = true;
    });
    ...
    jQuery('body').on('click', '.chs-btn-wrap', function (e) {
      ...
      // if (self.hasClass('plansopen')) {
      //   jQuery('.chs-plan-single-wrap').children('.chs-dtl-plan').slideUp();
      //   return false;
      // }

      jQuery('.chs-plan-single-wrap').children('.chs-dtl-plan').slideUp();

      self.children('.chs-dtl-plan').slideDown();
      hide = false;
    });
...
(function ($) {
  ...
  $(() => {
    const win = $(window);
    const slider = $(".wp-block-gallery ul");
